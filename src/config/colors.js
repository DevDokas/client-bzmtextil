...
export const DetailColor = '#880000';

export const SectionTextColor = '#d7d7d7';
...
export const HoverShadowColor = '#4380b0';

export const ButtonColor = '#8e44ad';

export const InputBackgroundColor = '#393939';

export const successColor = '#07DE40';
export const infoColor = '#0197F6';
export const warningColor = '#F2AF29';
export const errorColor = '#E30B0B';
